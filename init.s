...
.LM22:
	movl	$174353522, 4(%rsp)
	.stabn	68,0,41,.LM23-.LFBB2
.LM23:
	call	cprintf
	.stabn	68,0,44,.LM24-.LFBB2
.LM24:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L11:
	.stabn	68,0,64,.LM27-.LFBB3
.LM27:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,67,.LM28-.LFBB3
.LM28:
	cmpq	$0, panicstr(%rip)
	je	.L16
	.p2align 4,,10
...
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,75,.LM33-.LFBB3
.LM33:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC6, %edi
	.stabn	68,0,74,.LM34-.LFBB3
.LM34:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	movq	%rax, 16(%rsp)
	.stabn	68,0,75,.LM35-.LFBB3
.LM35:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,76,.LM36-.LFBB3
.LM36:
	movq	%rbx, %rdi
	movq	%rsp, %rsi
	call	vcprintf
...
.LM39:
	...
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,92,.LM40-.LFBB4
.LM40:
	leaq	224(%rsp), %rax
	.stabn	68,0,93,.LM41-.LFBB4
.LM41:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC9, %edi
...
.LM42:
	...
	movl	$48, 4(%rsp)
	movq	%rax, 16(%rsp)
	.stabn	68,0,93,.LM43-.LFBB4
.LM43:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,94,.LM44-.LFBB4
.LM44:
	movq	%rsp, %rsi
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,95,.LM45-.LFBB4
.LM45:
	xorl	%eax, %eax
	movl	$.LC7, %edi
	call	cprintf
	.stabn	68,0,97,.LM46-.LFBB4
.LM46:
	movq	24(%rsp), %rax
	xorq	%fs:40, %rax
	jne	.L21
